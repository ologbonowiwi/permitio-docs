...
<p className="intro-paragraph">Every application out there needs an authorization layer - but that doesn’t mean you need to build it from scratch.
That’s what Permit here is for! </p>
