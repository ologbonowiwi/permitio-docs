...
<p className="intro-paragraph">Policy decisions are often **driven by data**. While you can pass data in the check arguments, some of it would be **synced
to Permit in advance**. This guide will walk you through the data entities and how to sync them to Permit. </p>
