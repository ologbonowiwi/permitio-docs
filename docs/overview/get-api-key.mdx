...
<p className="intro-paragraph">To start using Permit.io, you’ll need an API key to authenticate your application with the Permit platform. This key is
essential for accessing Permit’s authorization services and managing your app's permissions. </p>
