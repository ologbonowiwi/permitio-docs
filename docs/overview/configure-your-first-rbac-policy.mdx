...
<p className="intro-paragraph">**Role-Based Access Control (RBAC)** is a method for managing access to resources by assigning permissions based on user
...
[Permit RBAC home page](https://www.permit.io/rbac) to learn more. </p>
