...
<p className="intro-paragraph">Performing your first **policy check** is a key step in understanding and validating the policies you’ve configured.
...
to perform specific actions on a resource. This ensures that your access control model is working as intended. </p>
