...
<p className="intro-paragraph">When building conditions, you need to be aware of the different types of operators you can use to construct your complex condition rules.
There are two types of operators that you need to be aware of - **Logical** and **Comparison**. </p>
