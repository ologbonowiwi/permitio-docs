...
<p className="intro-paragraph">Tenants are used to group users and roles together. A user can have different roles in multiple tenants.
The most common use case for using tenants is organization or company. </p>
