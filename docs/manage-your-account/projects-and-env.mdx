...
<p className="intro-paragraph">A Permit environment is a silo (a logical grouping) of your policy (roles, conditions, etc.) and data (users, tenants,
role assignments, etc.). You can create multiple environments for each of your projects. </p>
