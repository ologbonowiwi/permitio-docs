...
<p className="intro-paragraph">**Permit.io** enables simple authorization management by working **seamlessly** with most authentication providers.
...
just before granting thr user access to the application. </p>
