...
<p className="intro-paragraph">Permit.io, unlike other permission services, supports multiple policy engines and languages.
This support is enabled via Permit's [policy-editor](https://app.permit.io/policy-editor) (which generates policy as code in multiple languages) and via [OPAL](https://github.com/permitio/opal) which can manage multiple agents. </p>
