...
<p className="intro-paragraph">This section aims to explain how new users are created within Permit.
In short, Users can be added and managed via the [User Management](/how-to/sync-users#via-the-user-management-screen) screen,
by using the supported [SDKs](/how-to/sync-users#via-the-sdks), or via the [API](/how-to/sync-users#via-the-api). </p>
