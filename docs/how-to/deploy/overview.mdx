...
<p className="intro-paragraph">If you've reached this point, it's likely that you have successfully [completed the onboarding guide](/quickstart),
connected your application with Permit, and checked for permissions. Now, let's dive into the different deployment
options available for incorporating Permit into your app at scale. </p>
