...
<p className="intro-paragraph">If you've made it here, it means you've likely [completed the onboarding guide](/quickstart),
successfully connected your application with Permit, and checked for permissions. Perhaps you've even delved into
the basic/SaaS deployment options and are now intrigued by the idea of exploring an on-premise deployment. </p>
