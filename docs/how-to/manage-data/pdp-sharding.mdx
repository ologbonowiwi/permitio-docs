...
<p className="intro-paragraph">[PDP](/overview/glossary#pdp) Sharding is a technique for scaling Policy Decision Points (PDPs) horizontally,
by splitting the data into multiple PDPs, each responsible for a subset of your tenants. </p>
