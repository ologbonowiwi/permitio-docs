...
<p className="intro-paragraph">In order to forward logs to your preferred logging platform, you can use the Permit Logs Forwarder.
Currently we support forwarding logs to ElasticSearch and stdout of the FluentBit container. </p>
