...
<p className="intro-paragraph">You encountered this error because either your user account lacks the appropriate role to carry out the desired action, or the existing
role needs additional permissions. </p>
