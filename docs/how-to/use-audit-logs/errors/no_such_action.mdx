...
<p className="intro-paragraph">The error has arisen because the specified action for the provided resource couldn't be found in the permit check. Ensure that both the resource and action entered in the permit check are correct and case-sensitive. </p>
