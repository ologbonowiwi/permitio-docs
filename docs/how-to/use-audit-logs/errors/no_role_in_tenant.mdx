...
<p className="intro-paragraph">This error has occurred because you're attempting to check permissions for a user who hasn't been assigned any roles within this tenant. </p>
