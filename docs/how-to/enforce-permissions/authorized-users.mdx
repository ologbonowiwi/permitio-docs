...
<p className="intro-paragraph">To get all users who have access to a resource, you can use the `permit.authorized_users` function.
This function returns a list of users who have access to perform a specific action on a resource. </p>
