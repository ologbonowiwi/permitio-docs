...
<p className="intro-paragraph">Besides the standard `check` and data filtering functions, applications may require additional information such as role assignments, roles, tenants, etc. </p>
