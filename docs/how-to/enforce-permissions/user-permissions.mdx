...
<p className="intro-paragraph">To get all user permissions irrespective of the tenant, you can use the `permit.GetUserPermissions` function.
This function determines all user permissions for every registered resource across all tenants. </p>
