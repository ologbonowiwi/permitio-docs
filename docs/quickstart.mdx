...
<p className="intro-paragraph">Welcome to Permit! In this quick tutorial, we will go over the basic steps of setting up your account with Permit and creating
a very basic authorization policy. Let’s get started! </p>
